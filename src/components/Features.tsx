...
export function Features() {
  ...
  return (
    <section id="features" className="pt-24 pb-12 bg-ayu-bg relative border-t border-ayu-line">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    <div
                      className={clsx(
                        ...
                        activeFeature === index ? 'bg-ayu-bg shadow-sm' : 'bg-transparent'
                      )}
                    >
                    ...
                    <h3
                      className={clsx(
                        ...
                        activeFeature === index ? 'text-ayu-fg' : 'text-ayu-fg/80'
                      )}
                    >
                      {feature.title}
                    </h3>
          ...
          <div className="w-full lg:w-2/3 lg:sticky lg:top-24 h-fit">
            <div className="relative rounded-3xl border border-ayu-line bg-white shadow-2xl overflow-hidden perspective-1000">
              ...
              <div className="relative bg-ayu-bg/10 min-h-[400px] flex items-start justify-center">
